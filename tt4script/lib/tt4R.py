        ...
        try:
            ...
            if GPIO.input(bInt)==0:
                ...
                while count<(thisSensByte):
                    cmRawData[0][index]=int(((result[count+11]<<8)+result[count+10])*10) #fF/10
                    count=count+2
                    index=index+1                
        except KeyboardInterrupt:
            GPIO.clearnup()
    ...
    while countByte<(txNum+rxNum)*4:
        ...
        try:
            ...
            if GPIO.input(bInt)==0:
                ...
                count=0          
                while count<(thisSensByte):
                    cpRawData[0][index]=int(((result[count+11]<<8)+result[count+10])*10) #fF/10
                    count=count+2
                    index=index+1                   
        except KeyboardInterrupt:
            GPIO.cleanup()
...
#        fprint=0
    ...
    while True:
        ...
        try:
            ...
            for i in range(txNum*2,txNum*2+rxNum-1):#range(0,txNum+rxNum-1):
